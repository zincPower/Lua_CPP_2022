...
// 检查第一个参数是否是一个有效的数组
// 如果元表类型不对，则会抛出
// .../Lua/Lua_CPP_2022/9、userdata/用户数据/newarray_面向对象.lua:15: bad argument #1 to 'get' (df expected, got Jiang.array)
...
void arrayObjectDemo() {
    ...
    std::string fileName = "/Users/jiangpengyong/Desktop/code/Lua/Lua_CPP_2022/9、userdata/用户数据_面向对象/newarray_面向对象.lua";
